%% Define experiment for Figure 4b (lower row)
% This script is reproduces the experiment of Figure 4 (lower row) in the 
% paper [1], cf. Appendix.
% See 'load_experiment_Figure4b_GaussRankOneMeas_rank5.m' for a script 
