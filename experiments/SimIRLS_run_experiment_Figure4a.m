%% Define experiment for Figure 4a (upper row)
% This script is reproduces the experiment of Figure 4 (upper row) in the 
% paper [1], cf. Appendix.
% See 'load_experiment_Figure4a_GaussRankOneMeas_rank1.m' for a script 
...
Params.ExampleName ='LRRS_GRank1_rank1_n2_40';
