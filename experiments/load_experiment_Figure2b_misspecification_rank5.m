%% Load data for Figure 2 (second row)
% This script is loads the experiment data for Figure 2, second row, in the 
% paper [1], cf. Section 4.
% Note: The corresponding experiment can be reproduced by using the script
% 'SimIRLS_run_experiment_Figure2b.m'.
...
clear
ms_all    = [250:25:1000,1050:50:1500,1600:100:2000];
sparsitys = [20:5:60];
load('LRRS_m_350_800_LRRS_Gaussian_rank5_n2_40_Gaussian_dense_merged_fully_K1_20_2023-05-15_1333-16-111','Example')
...
for ii = 1:length(sparsitys)
    exp_part1 = 'LRRS_Gaussian_rank5_n2_40_Gaussian_dense_merged_fully_';
...
for i=1:length(Example.alg_name_out)
    ...
    %% Save file
    filename=strcat('results/experiment_Gauss_n256_40_rank5_misspec_',Example.alg_name{i});
    save_LRRS_plots;
end