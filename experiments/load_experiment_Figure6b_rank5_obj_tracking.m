%% Load data for Figure 6b
% This script is loads the experiment data for Figure 6b, in the appendix of
% the paper [1].
% To reproduce the experiment, please run
% 'SimIRLS_run_experiment_Figure6b.m'.
%
% Reference:
...
clear
filename = 'LRRS_Gaussian_rank5_obj_tracking';
load(filename);
openfig(filename);
