function Example = LRRS_Gaussian_rank5_convg_plot_def()
%LRRS_Gaussian_rank5_convg_plot_def This function defines the problem
%parameters of the experiment used in Figure 3 of [1].
%
% Reference:
...
descr = 'LRRS_Gaussian_rank5_convg_plot';
