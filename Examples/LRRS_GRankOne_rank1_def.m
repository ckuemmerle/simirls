function Example = LRRS_GRankOne_rank1_def()
%LRRS_GRankOne_rank1_de This function defines the problem
% parameters of a simple experiment for low-rank and row-sparse matrix
% recovery from Gaussian rank-one measurements, cf. Appendix A.2 of [1].
...
samplemodel = struct; 
samplemodel.mode =  'Gaussian_rank1';
samplemodel.oversampling = 2.75;
