function Example = LRRS_Gaussian_rank5_obj_tracking_def()
%LRRS_Gaussian_rank5_obj_tracking_rec_def This function defines the problem
% parameters used in Figure 6 (second part) of [1].
%
% Reference:
