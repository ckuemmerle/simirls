function Example = LRRS_Gaussian_rank1_def()
%LRRS_Gaussian_rank1_def This function defines the problem
...
% experiments of Figure 1 and Figure 2 (albeit the latter with prob.r=5) 
% in Section 4 or [1].
%
% Reference:
...
descr = 'LRRS_Gaussian_rank1_n2_40';
